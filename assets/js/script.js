...
/**
 * Gets the operands (numbers) and the operator directly from the DOM and 
...
/**
 * Gets the current score from the DOM and add increments it by 1 
 */
...
/**
 * Gets the current incorret score from the DOM and add increments it by 1 
 */
